...
export default function Confidentialite() {
  ...
  return (
    <div style={s}>
      ...
      <p style={p}>
        EntretienZen — entretienzen.com<br />
        Contact : contact@entretienzen.com
      </p>
      ...
      <p style={p}>
        Pour exercer ces droits, envoyez un email à <strong>contact@entretienzen.com</strong>. Nous répondrons sous 30 jours.
      </p>
