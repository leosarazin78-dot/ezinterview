...
export async function GET(request) {
  try {
    ...
    // Charge les métadonnées légères + plan_data pour compatibilité
    const { data, error } = await supabase
      .from("plans")
      .select("id, job_title, company, interview_date, next_interlocutor, completed_days, plan_data, job_data, created_at")
      .eq("user_id", user.id)
